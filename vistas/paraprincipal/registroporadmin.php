    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="login-box well">
                ...
                <form action="index.php?accion=registrodeladmin" role="form" method="POST" enctype="multipart/form-data">
                    
                    <h3 class="panel-title">REGISTRA EL USUARIO QUE DESEES <?php  if(isset($_SESSION["logged"])){
            echo ' '.$_SESSION["logged"]["UsuarioLogin"];}?> </h3>
                         <br><br>
